var vivek={}
vivek.irs=(function(){
    var canvas,context,themainshape;
    var bodies=[];
    ...
    var stagesetup=(function(){
        ...
        thecolorgraphics.setStrokeStyle(1).beginStroke(Graphics.getRGB(0,0,0,1)).beginFill(Graphics.getRGB(0,255,0,1)).rect(0,0,960,900).endFill();
    ...
    var theGreatCircles=(function(){
        ...
        var spawn=function(){
            ...
            cirBmp.x=Math.round(20+Math.random()*300);
            //cirBmp.y=550;
            cirBmp.y=-3;
            cirBmp.regX=40;
            cirBmp.regY=40;
           	cirBmp.snapToPixel = true;
			cirBmp.mouseEnabled = true;
            cirBmp.setClickedstatus=false;
            cirBmp.greatColor=color;
            cirBmp.onPress=function(e){
            ...
            andBmp.regX=27;
            andBmp.regY=27;
            andBmp.snapToPixel=true;
            andBmp.mouseEnabled=true;
            
            stage.addChild(cirBmp);
            stage.addChild(andBmp);
            
            myphysics.addBodies(cirBmp,andBmp);
        }
    ...
    var myphysics=(function(){
        ...
        var theactorObject=function(body,skin,skin2){
            this.body=body;
            this.skin=skin;
            this.skin2=skin2;
            this.update=function(i){
                if(this.skin.setClickedstatus==false){
                    
              this.skin.rotation=this.body.GetAngle()*(180/Math.PI);
              this.skin.x=this.body.GetWorldCenter().x*SCALE;
              this.skin.y=this.body.GetWorldCenter().y*SCALE;
                this.skin2.rotation=this.body.GetAngle()*(180/Math.PI);
              this.skin2.x=this.body.GetWorldCenter().x*SCALE;
              this.skin2.y=this.body.GetWorldCenter().y*SCALE;
                ...
                var myGreatColor=this.skin.greatColor;
                Tween.get(this.skin).to({x:415,y:200}, 3000,Ease.bounceOut).call(function(){
                   
                    var thecolorgraphicsnew=new Graphics();
        thecolorgraphicsnew.setStrokeStyle(1).beginStroke(Graphics.getRGB(0,0,0,1)).beginFill(myGreatColor).rect(0,0,960,900).endFill();
        themainshape.graphics=thecolorgraphicsnew;
                });
        ...
        var addBodies=function(theimage,theimage2){
        ...
        thedynamicbodydef.position.x=theimage.x/SCALE;
        thedynamicbodydef.position.y=theimage.y/SCALE;
        
        var thedynamicbody=world.CreateBody(thedynamicbodydef);
        thedynamicbody.CreateFixture(bodyfixturedef);
        
        var actor=new theactorObject(thedynamicbody,theimage,theimage2);
